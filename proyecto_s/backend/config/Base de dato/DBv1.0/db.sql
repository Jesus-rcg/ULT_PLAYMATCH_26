...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-05-2026 a las 00:33:25
...
(6, 2, 1, 3, 1, 'Estadio Norte', '2026-06-01', '16:00:00', 'Pendiente', 1),
(7, 2, 2, 4, 1, 'Estadio Norte', '2026-06-02', '16:00:00', 'Pendiente', 1),
(8, 2, 5, 7, 1, 'Estadio Norte', '2026-06-03', '16:00:00', 'Pendiente', 1),
...
(18, 1, 1, 4, 3, 'Por definir', '2026-05-28', '12:00:00', 'Pendiente', 1),
(19, 1, 5, 3, 3, 'Por definir', '2026-05-28', '12:00:00', 'Pendiente', 1),
(20, 1, 6, 2, 3, 'Por definir', '2026-05-28', '12:00:00', 'Pendiente', 1),
(21, 1, 1, 3, 4, 'Por definir', '2026-05-29', '12:00:00', 'Pendiente', 1),
(22, 1, 4, 2, 4, 'Por definir', '2026-05-29', '12:00:00', 'Pendiente', 1),
(23, 1, 5, 6, 4, 'Por definir', '2026-05-29', '12:00:00', 'Pendiente', 1),
(24, 1, 1, 2, 5, 'Por definir', '2026-05-30', '12:00:00', 'Pendiente', 1),
(25, 1, 3, 6, 5, 'Por definir', '2026-05-30', '12:00:00', 'Pendiente', 1),
(26, 1, 4, 5, 5, 'Por definir', '2026-05-30', '12:00:00', 'Pendiente', 1),
(27, 2, 2, 3, 2, 'mngtyujh', '2026-05-29', '13:30:00', 'Pendiente', 1);
...
(14, 17, 'anchoa', 'Semiprofesional', 'Grupos', 'bogota ', '2026-05-25', '2026-06-26', 'Inscripciones Abiertas', 0),
(15, 19, 'mi primer torneo', 'Amateur', 'Liga', 'bogota', '2026-06-01', '2026-12-20', 'Inscripciones Abiertas', 1);
...
(3, 2, 'Luis', 'Martinez', '1992-11-05', '3023456789', 'luis@gmail.com', '123456', 1),
...
(17, 1, 'kevin', 'cerpa granados', '2026-04-01', '1', 'k@gmail.com', '$2b$10$R3aXf783bdxFgwugUqW7.OWkaRtWMmCSSwzBzFc30rrz4WW.NMxqa', 1),
...
--
ALTER TABLE `encuentros`
  MODIFY `id_encuentro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `inscripcionesequipos`
  MODIFY `id_inscripcion_e` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;

--
-- AUTO_INCREMENT de la tabla `inscripcionesjugadores`
--
ALTER TABLE `inscripcionesjugadores`
  MODIFY `id_inscripcion_j` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
