...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-07-2026 a las 19:42:16
...
INSERT INTO `categorias` (`id_categoria`, `nombre_categoria`, `edad_minima`, `edad_maxima`, `activo`) VALUES
(1, 'Unica', 17, 60, 1);
...
CREATE TABLE `cronologias` (
  ...
  `evento` enum('Gol','Amarilla','Roja','Azul') NOT NULL,
...
CREATE TABLE `jugadores` (
  ...
  `id_usuario` int(11) NOT NULL,
  `id_equipo` int(11) NOT NULL,
  `tarjetas` enum('amarillas','azules','rojas','') DEFAULT NULL,
...
INSERT INTO `jugadores` (`id_jugador`, `id_usuario`, `id_equipo`, `tarjetas`, `goles`, `numero_camiseta`, `activo`) VALUES
(1, 1, 1, NULL, NULL, 1, 1),
(2, 2, 0, NULL, NULL, 4, 1),
(3, 3, 0, NULL, NULL, 5, 1),
(4, 4, 0, NULL, NULL, 8, 1),
(5, 5, 0, NULL, NULL, 10, 1),
(6, 6, 0, NULL, NULL, 9, 1),
(7, 7, 0, NULL, NULL, 3, 1),
(8, 8, 0, NULL, NULL, 6, 1),
(9, 9, 0, NULL, NULL, 11, 1),
(10, 10, 0, NULL, NULL, 12, 1),
(11, 19, 0, NULL, NULL, 10, 1),
(13, 16, 0, NULL, NULL, 11, 0),
(16, 17, 0, NULL, NULL, 20, 1);
...
INSERT INTO `tipodocumento` (`id_documento`, `nombre_documento`) VALUES
(1, 'Cedula'),
...
INSERT INTO `torneos` (`id_torneo`, `id_usuario`, `id_categoria`, `nombre_torneo`, `tipo_torneo`, `ciudad`, `fecha_inicio`, `fecha_fin`, `estado`, `activo`) VALUES
(1, 1, 0, 'Liga Profesional Tolima', 'Liga', 'Ibague', '2026-05-01', '2026-08-31', 'Comenzo', 1),
(2, 2, 0, 'Copa Juvenil Sub 20', 'Grupos', 'Bogota', '2026-06-10', '2026-07-20', 'Inscripciones Abiertas', 1),
(3, 3, 0, 'Torneo Regional', 'Eliminacion Directa', 'Cali', '2026-04-20', '2026-06-15', 'Comenzo', 1),
(4, 4, 0, 'Liga Amateur Medellin', 'Liga', 'Medellin', '2026-03-01', '2026-05-31', 'Comenzo', 1),
(5, 5, 0, 'Copa Final Nacional', 'Eliminacion Directa', 'Barranquilla', '2026-07-01', '2026-09-01', 'Inscripciones Abiertas', 1),
(7, 17, 0, 'sdfghjfghjqwerthbvcxserf', 'Grupos', 'xcvbnawsedrftghb vc', '2026-05-20', '2026-05-30', 'Inscripciones Abiertas', 0),
(8, 17, 0, 'sdfgh', 'Liga', 'xcvbn', '2026-05-20', '2026-05-21', 'Inscripciones Abiertas', 0),
(9, 17, 0, 'xwecvrbtnymumunbvrecwxce', 'Liga', 'asertghbvcd', '2026-05-19', '2026-05-30', 'Comenzo', 0),
(10, 17, 0, 'wertyhvdswe4rtyhvdsertg', 'Liga', 'xcgtrdsxcv', '2026-05-01', '2026-05-18', 'Finalizado', 0),
(11, 17, 0, 'asdefrgtyum', 'Liga', 'xcrvtbynum', '2026-05-25', '2026-05-31', 'Inscripciones Abiertas', 0),
(12, 17, 0, 'q', 'Liga', 'w', '2026-05-21', '2026-05-27', 'Comenzo', 0),
(13, 17, 0, 'd', 'Liga', 'g', '2026-05-23', '2026-05-31', 'Inscripciones Abiertas', 0),
(14, 17, 0, 'anchoa', 'Grupos', 'bogota ', '2026-05-25', '2026-06-26', 'Inscripciones Abiertas', 1),
(15, 19, 0, 'mi primer torneo', 'Liga', 'bogota', '2026-06-01', '2026-12-20', 'Inscripciones Abiertas', 1),
(16, 19, 0, 'segundo torneo', 'Eliminacion Directa', 'cali', '2026-06-05', '2026-11-30', 'Inscripciones Abiertas', 1),
(17, 19, 0, 'tercer torneo', 'Liga', 'barranca', '2026-06-05', '2027-01-31', 'Inscripciones Abiertas', 1),
(18, 19, 0, 'zdfrgthyj', 'Liga', 'dwefgrthyju', '2026-06-01', '2026-11-03', 'Inscripciones Abiertas', 1);
...
INSERT INTO `usuarios` (`id_usuario`, `id_documento`, `id_rol`, `nombre_usuario`, `apellido_usuario`, `fecha_nacimiento`, `telefono`, `email`, `password`, `activo`) VALUES
(1, 1, 1, 'Carlos', 'Ramirez', '1995-03-12', '30012', 'carlos@gmail.com', '123456', 0),
(2, 1, 2, 'Anastacio', 'Gomez', '1998-07-25', '3012345678', 'ana@gmail.com', '123456', 0),
(3, 1, 2, 'Luis', 'Martinez', '1992-11-05', '3023456789', 'luis@gmail.com', '123456', 0),
(4, 1, 3, 'Maria', 'Lopez', '2000-01-18', '3034567890', 'maria@gmail.com', '123456', 1),
(5, 1, 1, 'Jorge', 'Hernandez', '1991-09-30', '3045678901', 'jorge@gmail.com', '123456', 1),
(6, 1, 2, 'Sofia', 'Torr', '1997-06-14', '3056789012', 'sofia@gmail.com', '123456', 1),
(7, 1, 3, 'Diego', 'Castro', '1994-12-22', '3067890123', 'diego@gmail.com', '123456', 1),
(8, 1, 2, 'Laura', 'Vargas', '1999-04-09', '3078901234', 'laura@gmail.com', '123456', 1),
(9, 1, 1, 'Andres', 'Morales', '1993-08-17', '3089012345', 'andres@gmail.com', '123456', 1),
(10, 1, 3, 'Paula', 'Rojas', '1996-02-28', '3090123456', 'paula@gmail.com', '123456', 1),
(16, 1, 3, 'k', 'cerpa', '2026-04-02', '3', 'kkk@gmail.com', '$2b$10$451eH9UUmNmRCg1N.WrnR.5J5XLjcn1TKo3842vObLyoI6ZnzZ4Vi', 1),
(17, 1, 1, 'kevin', 'cerpa granados', '2026-04-01', '1', 'k@gmail.com', '$2b$10$FM58xnRDqpT9TEwDuNJtwugqFHlzI7H6Hvu4oSbAGlfHWAUI1NOYq', 1),
(19, 1, 2, 'kevin', 'granados', '2026-04-01', '2', 'kk@gmail.com', '$2b$10$Kja2UyjE9IyvwIuqZ0vrYOl88TMWgCrHjBXkbdE/WX2CqmwpLsAVe', 1),
(27, 1, 1, 'SebastIan', 'Alvarez', '2002-07-18', '3218552200', 'sebastian@gmail.com', '$2b$10$fgECgivlu2CqYhpH5ivbPu56V/Q2L1DonziTQ9BxgC/t9z/m1OoNO', 1),
(28, 1, 3, 'Sebastian', 'Usuario', '2006-08-10', '3218205566', 'pruebausuario@gmail.com', '$2b$10$X8FsNtydSB0ypkDJqPLb7uooi2ED4drSKF1phBLxMeVkFllFNuD5u', 1),
(29, 1, 3, 'Prueba', 'Sebas', '2026-07-22', '3218204529', 'ja4971925@gmail.com', '$2b$10$9Z1/uaF86GIr0LEBG3x9Iu6JN/7byw9E9fDdv/vGbAAD5vlxxcGXC', 1);
...
ALTER TABLE `equipos`
  ...
  ADD UNIQUE KEY `uq_nombre_equipo` (`nombre_equipo`),
...
ALTER TABLE `tipodocumento`
  ...
  ADD UNIQUE KEY `nombre_documento` (`nombre_documento`);
...
ALTER TABLE `torneos`
  ...
  ADD UNIQUE KEY `uq_torneos_nombre` (`nombre_torneo`),
  ADD KEY `id_usuario` (`id_usuario`),
  ADD KEY `fk_torneos_categorias` (`id_categoria`);
...
ALTER TABLE `usuarios`
  ...
  ADD KEY `fk_usuarios_tipodocumento` (`id_documento`);
...
--
ALTER TABLE `cronologias`
  MODIFY `id_cronologia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `jugadores`
  ADD CONSTRAINT `fk_jugadores_equipos` FOREIGN KEY (`id_equipo`) REFERENCES `equipos` (`id_equipo`) ON UPDATE CASCADE,
...
--
ALTER TABLE `torneos`
  ADD CONSTRAINT `fk_torneos_categorias` FOREIGN KEY (`id_categoria`) REFERENCES `categorias` (`id_categoria`) ON UPDATE CASCADE,
...
ALTER TABLE `usuarios`
  ...
  ADD CONSTRAINT `fk_usuarios_tipodocumento` FOREIGN KEY (`id_documento`) REFERENCES `tipodocumento` (`id_documento`);
COMMIT;
