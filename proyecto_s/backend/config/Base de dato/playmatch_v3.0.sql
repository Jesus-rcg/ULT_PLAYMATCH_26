...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-07-2026 a las 06:25:59
...
INSERT INTO `rolesusuarios` (`id_usuario`, `id_rol`) VALUES
(1, 1),
(2, 2),
(3, 2),
(4, 3),
...
INSERT INTO `torneos` (`id_torneo`, `id_usuario`, `nombre_torneo`, `tipo_torneo`, `ciudad`, `fecha_inicio`, `fecha_fin`, `estado`, `activo`) VALUES
(1, 1, 'Liga Profesional Tolima', 'Liga', 'Ibague', '2026-05-01', '2026-08-31', 'Comenzo', 1),
(2, 2, 'Copa Juvenil Sub 20', 'Grupos', 'Bogota', '2026-06-10', '2026-07-20', 'Inscripciones Abiertas', 1),
(3, 3, 'Torneo Regional', 'Eliminacion Directa', 'Cali', '2026-04-20', '2026-06-15', 'Comenzo', 1),
(4, 4, 'Liga Amateur Medellin', 'Liga', 'Medellin', '2026-03-01', '2026-05-31', 'Comenzo', 1),
(5, 5, 'Copa Final Nacional', 'Eliminacion Directa', 'Barranquilla', '2026-07-01', '2026-09-01', 'Inscripciones Abiertas', 1),
(7, 17, 'sdfghjfghjqwerthbvcxserf', 'Grupos', 'xcvbnawsedrftghb vc', '2026-05-20', '2026-05-30', 'Inscripciones Abiertas', 0),
(8, 17, 'sdfgh', 'Liga', 'xcvbn', '2026-05-20', '2026-05-21', 'Inscripciones Abiertas', 0),
(9, 17, 'xwecvrbtnymumunbvrecwxce', 'Liga', 'asertghbvcd', '2026-05-19', '2026-05-30', 'Comenzo', 0),
(10, 17, 'wertyhvdswe4rtyhvdsertg', 'Liga', 'xcgtrdsxcv', '2026-05-01', '2026-05-18', 'Finalizado', 0),
(11, 17, 'asdefrgtyum', 'Liga', 'xcrvtbynum', '2026-05-25', '2026-05-31', 'Inscripciones Abiertas', 0),
(12, 17, 'q', 'Liga', 'w', '2026-05-21', '2026-05-27', 'Comenzo', 0),
(13, 17, 'd', 'Liga', 'g', '2026-05-23', '2026-05-31', 'Inscripciones Abiertas', 0),
(14, 17, 'anchoa', 'Grupos', 'bogota ', '2026-05-25', '2026-06-26', 'Inscripciones Abiertas', 1),
(15, 19, 'mi primer torneo', 'Liga', 'bogota', '2026-06-01', '2026-12-20', 'Inscripciones Abiertas', 1),
(16, 19, 'segundo torneo', 'Eliminacion Directa', 'cali', '2026-06-05', '2026-11-30', 'Inscripciones Abiertas', 1),
(17, 19, 'tercer torneo', 'Liga', 'barranca', '2026-06-05', '2027-01-31', 'Inscripciones Abiertas', 1),
(18, 19, 'zdfrgthyj', 'Liga', 'dwefgrthyju', '2026-06-01', '2026-11-03', 'Inscripciones Abiertas', 1);
...
--
ALTER TABLE `rolesusuarios`
  ADD CONSTRAINT `rolesusuarios_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`),
  ADD CONSTRAINT `rolesusuarios_ibfk_2` FOREIGN KEY (`id_rol`) REFERENCES `roles` (`id_rol`);
